...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def parse_board_state(self, game_state : gamelib.GameState):
        ...
        return (my_resources, their_resources, my_health, their_health)
    ...
    def starter_strategy(self, game_state):
        ...
        # Get the info
        my_resources, their_resources, my_health, their_health = self.parse_board_state(game_state)
        my_structure_points, my_mobile_points = my_resources
        their_structure_points, their_mobile_points = their_resources


        # First, basic defenses
        self.build_defences(game_state)

        if their_mobile_points > 12:
            interceptor_spawn_loc = [[5, 8], [22, 8]]
            game_state.attempt_spawn(INTERCEPTOR, interceptor_spawn_loc, 2)

        if game_state.turn_number % 5 == 1:
            scout_spawn_location_options = [[5, 8], [22, 8]]
    ...
    def defense_priority_1(self, game_state):
        ...
        back_walls_loc = back_walls_loc = [[5, 10], [22, 10], [6, 9], [21, 9], [7, 8], [20, 8]] + [[col, 7] for col in range(8, 20)]
