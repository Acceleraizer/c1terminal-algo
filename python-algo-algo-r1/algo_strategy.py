...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_defences(self, game_state):
        ...
        turret_locations_secondary = [[3, 11], [23, 10], [22, 9]]
        turret_locations_3 = [[24, 11], [21, 8], [20, 7]]
        # attempt_spawn will try to spawn units if we have resources, and will check if a blocking unit is already there
        # Place walls in front of turrets to soak up damage for them
        wall_locations_key = [[26, 13], [27, 13], [3, 12], [4, 11]]
        wall_locations_key_2 = [[0, 13], [1, 13], [2, 13], [24, 12], [23, 11], [19, 10], [18, 9]]
        wall_locations_key_3 = [[25, 13], [21, 9], [20, 8], [19, 7]]
        wall_locations_path =  [[22, 13], [21, 12], [20, 11], [5, 10], [22, 10], [6, 9], [15, 9], [16, 9], [17, 9], [7, 8], [14, 8], [8, 7], [13, 7], [9, 6], [10, 6], [11, 6], [12, 6], [18, 6]]
