...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        EARLY_GAME_MAP = \
        {"wall_l2" : [[20, 12], [0, 13], [1, 13], [23, 13], [26, 13], [27, 13], [4, 12], [5, 11], [21, 12]]
        ,"wall_l1" : []
        ,"turret_l1" : [[2, 13], [3, 12], [24, 12], [25, 12], [20, 11]]
        ,"scouts": []#[[4,9], [7,4], [10,3]]
        ,"inters" : [[6,7], [9,4]]
        }
        MID_GAME_MAP = \
        {"wall_l2" :EARLY_GAME_MAP["wall_l2"]
        ,"turret_l1" : EARLY_GAME_MAP["turret_l1"]
        ,"wall_l1" :[[23, 12], [6, 10], [7, 9], [18, 9], [8, 8], [9, 8], [10, 8], [11, 8], [12, 8], [13, 8], [14, 8], [15, 8], [16, 8], [17, 8]] +  [[3, 13], [23, 11], [19, 10], [22, 10], [21, 9]]
        ,"cost": 0
        , "wall_l2_aux" : [[3, 13], [23, 11], [19, 10], [22, 10], [21, 9]]
        ,"support_l1": [[16, 6], [17, 6], [18, 6], [17, 5]]}
        MID_GAME_MAP["cost"] = 0.5*len(MID_GAME_MAP["wall_l1"])
        ...
        {"wall_l2": [[24, 13], [25, 13], [19, 12], [18,11], [26, 12], [20, 8]]
        ,"turret_l1" : [[19, 11], [18, 10], [23, 10]]
        }
        ...
        LATE_GAME_SHIELD = \
        {"shield_l2": [[14, 9], [15, 9], [16, 9], [15, 10], [16, 10], [17, 10]]
        }
    ...
    def compare_stats(self, best_stats, best_locs, new_stats,new_locs):
        ...
        if dmg > best_dmg or best_tur > tur or costdmg > best_costdmg:
